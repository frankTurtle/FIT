...
contract Fit is ERC721Enumerable, ReentrancyGuard, Ownable {
    ...
    string[] private namePrefixes = [
        ...
        "Light's", "Shimmering", "Darth Plateis", "Swole", "Iron", "Valkyrie", "Swoldier", "Broki", "Arnie"
    ];
    ...
    function tokenURI(uint256 tokenId) override public view returns (string memory) {
        ...
        string memory json = Base64.encode(bytes(string(abi.encodePacked('{"name": "FIT #', toString(tokenId), '", "description": "FIT is randomized fitness gear generated and stored on chain. Stats, images, and other functionality are intentionally omitted for others to interpret. Feel free to use FIT in any way you want.", "image": "data:image/svg+xml;base64,', Base64.encode(bytes(output)), '"}'))));
